<?php
  ...
  if(!empty($_POST)){
    ...
    if(!isEmail($email)){
      $errors[] = 'Debe insgresar un correo valido';
    }
  }
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-6 col-md-6" align="right">
              <p class="bold text-right"><a href="login.php">&nbsp&nbsp&nbsp  Inicia Sesión </a></p>
            </div>
          </div>
        </div>
      </div>
                    ...
                    <div class="wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.2s">
                      <div class="panel panel-skin">
                        <div class="panel-heading">
                          <h3 class="panel-title"><span class="fa fa-key"></span>Recupera tu contraseña</h3>
                        </div>
                        <div class="panel-body">
                          <div id="sendmessage">Tu mensaje ha sido enviado con éxito, Gracias!</div>
                          ...
                          <form action="" method="post" role="form" class="contactForm lead">
                            <div class="button">
                              <div class="row">
                                <div class="form-group">
                                  <label>Curp</label>
                                  <input type="text" name="Curp_Usuario" id="Curp_Usuario" class="form-control input-md" data-rule="required" maxlength="18" data-msg="Ingrese su Curp">
                            ...
                            <div class="button">
                              <div class="row">
                                <div class="form-group">
                                  <label>Correo</label>
                                  <input type="email" name="email" id="Email_Paciente" class="form-control input-md" data-rule="email" data-msg="Por favor introduzca un correo válido">
                                  <div class="validation"></div>
                                </div>
                              </div>
                            </div>                  
                            <div class="button">
                              <div class="row">
                                  ...
                                  <div class="row"><p>Revisa tu correo</p></div>
                                </div>
                              </div>
                            </div>
                          </form>
          ...
          <div class="col-sm-6 col-md-4">
            ...
            <div class="wow fadeInDown" data-wow-delay="0.1s">
              <div class="widget">
                <h5>Información</h5>
                <ul>
                  <li><a href="index.html" class="light">Inicio</a></li>
